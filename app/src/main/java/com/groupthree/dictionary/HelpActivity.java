...
public class HelpActivity extends AppCompatActivity {
    ...
    public ArrayList<ListHelp> getValues() {
        ...
        String[] values = {"Hỗ trợ học 600 từ vựng Toeic nhanh nhất và đơn giản nhất với ba chế độ học: học qua màn hình khóa, học qua các bài luyện tập và học qua chế độ nhắc từ."
                , "Khi kích hoạt chế độ này, màn hình khóa của điện thoại sẽ được thay thế bằng màn hình khóa của ứng dụng.Để mở khóa, người dùng phải trả lời đúng từ vựng trên màn hình khóa là gì bằng cách chọn một trong hai đáp án."
                , "Để hỗ trợ học nhanh 600 từ, chúng tôi hỗ trợ bốn phương thức luyện tập là: nghe lặp, lật từ, trắc nghiệm và luyện nói. Để có thể thực hiện các bài tập này, người dùng phải chọn mục 'Luyện tập' sau đó tích vào các chủ để cần luyện tập và nhấn vào nút 'bắt đầu'."
                , "Đây là một chế độ tiện dụng, giúp người dùng có thể học mọi lúc mọi nơi. Khi kích hoạt chế độ này, cứ khoảng10 giấy, ứng dụng sẽ hiện lên một cửa sổ nhỏ, có một từ vựng và nghĩa của từ nó. Khi bạn dùng điện thoại, thì nó sẽ đập vào mắt bạn và đi vào bộ não một cách tự nhiên. Các bạn yên tập việc hiển thị của sổ này không hề ảnh hưởng đến việc tương tác với ứng dụng của bạn. Các bạn vẫn có thể chạm vào các đôi tượng bên dưới cửa sổ mà không ảnh hưởng gì."};
